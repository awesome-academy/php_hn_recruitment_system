...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('bower_components/job_light/css/style.css') }}" />
    <link rel="stylesheet" type="text/css" href="{{ asset('bower_components/job_light/css/responsive.css') }}" />
...
<body>
    ...
    <script src="{{ asset('bower_components/job_light/js/custom.js') }}"></script>
