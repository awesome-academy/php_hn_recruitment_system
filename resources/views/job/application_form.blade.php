    ...
    <div class="main-content form-content">
        <div class="card">
            <div class="row">
                ...
                <div class="col-md-9">
                    <h1 class="text-center">{{ __('messages.application-from') }}</h1>
                    @if (Session::get('fail'))
                    ...
                    <div class="p-h-10">
                        <form class="m-t-15" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="tel" class="form-control" value="{{ $job->employerProfile->name }}"
                                        readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" name="cover_letter" id="exampleFormControlTextarea1"
                                        rows="3"></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="text-sm-right">
                                ...
                                <button type="submit" class="btn btn-gradient-success">{{ __('messages.save') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
