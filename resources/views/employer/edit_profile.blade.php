        ...
        <div class="main-content">
            <div class="container-fluid">
                <div class="page-header">
                    <h2 class="header-title">{{ __('messages.edit-profile') }}</h2>
                </div>
                <div class="card">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card-body">
                                ...
                                @endif
                                <form action="{{ route('employer.profiles.update', ['profile' => $profile]) }}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control" id="industry" type="text" name="industry"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control" id="company_size" type="text" name="company_size"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control" id="company_type" type="text" name="company_type"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea id="summernote-custom"
                                                name="description">{{ old('description') ? old('description') : $profile['description'] }}</textarea>
                                            @error('description')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control" id="cover_photo" type="file" name="cover_photo">
                                            @error('cover_photo')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
