        ...
        <div class="main-content">
            <div class="container-fluid">
                <div class="page-header">
                    <h2 class="header-title">{{ __('messages.experience') }}</h2>
                </div>
                <div class="card">
                    <div class="row">
                        <div class="col-md-12">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center font-size-18">
                                                        <a href="" data-toggle="modal"
                                                            data-target="#edit-modal-{{ $experience->id }}"
                                                            class="text-info"><i class="ti-pencil"></i></a>
                                                        <a href="" data-toggle="modal"
                                                            data-target="#modal-sm-{{ $experience->id }}"
                                                            class="text-danger"><i class="ti-trash"></i>
                                                        </a>
                                                    </td>
                                                </tr>
                                                {{-- Delete Confirmation Modal --}}
                                                <div class="modal fade" id="modal-sm-{{ $experience->id }}">
